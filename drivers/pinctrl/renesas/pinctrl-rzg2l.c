 ...
 * @iolh_groupd_ua: IOLH group D uA specific values (only for V2H/G3E SoCs)
...
struct rzg2l_hwcfg {
	...
	u16 iolh_groupd_ua[RZG2L_IOLH_IDX_MAX];
	u16 iolh_groupb_oi[4];
	bool drive_strength_ua;
	bool has_v2h_iolh_cfg;
	u8 func_base;
	u8 oen_max_pin;
	u8 oen_max_port;
...
static const u64 r9a09g057_variable_pin_cfg[] = {
	RZG2L_VARIABLE_PIN_CFG_PACK(11, 0, RZV2H_MPXED_PIN_FUNCS(B)),
	RZG2L_VARIABLE_PIN_CFG_PACK(11, 1, RZV2H_MPXED_PIN_FUNCS(B) | PIN_CFG_IEN),
	RZG2L_VARIABLE_PIN_CFG_PACK(11, 2, RZV2H_MPXED_PIN_FUNCS(B) | PIN_CFG_IEN),
	RZG2L_VARIABLE_PIN_CFG_PACK(11, 3, RZV2H_MPXED_PIN_FUNCS(B) | PIN_CFG_IEN),
	RZG2L_VARIABLE_PIN_CFG_PACK(11, 4, RZV2H_MPXED_PIN_FUNCS(B) | PIN_CFG_IEN),
	RZG2L_VARIABLE_PIN_CFG_PACK(11, 5, RZV2H_MPXED_PIN_FUNCS(B) | PIN_CFG_IEN),
};

static const u64 r9a09g047_variable_pin_cfg[] = {
	/* PA */
	RZG2L_VARIABLE_PIN_CFG_PACK(10, 0, RZV2H_MPXED_PIN_FUNCS(A) | PIN_CFG_IEN),
	RZG2L_VARIABLE_PIN_CFG_PACK(10, 1, RZV2H_MPXED_PIN_FUNCS(A)),
	RZG2L_VARIABLE_PIN_CFG_PACK(10, 2, RZV2H_MPXED_PIN_FUNCS(A)),
	RZG2L_VARIABLE_PIN_CFG_PACK(10, 3, RZV2H_MPXED_PIN_FUNCS(A)),
	RZG2L_VARIABLE_PIN_CFG_PACK(10, 4, RZV2H_MPXED_PIN_FUNCS(A)),
	RZG2L_VARIABLE_PIN_CFG_PACK(10, 5, RZV2H_MPXED_PIN_FUNCS(A)),
	RZG2L_VARIABLE_PIN_CFG_PACK(10, 6, RZV2H_MPXED_PIN_FUNCS(A)),
	RZG2L_VARIABLE_PIN_CFG_PACK(10, 7, RZV2H_MPXED_PIN_FUNCS(A)),

	/* PD */
	RZG2L_VARIABLE_PIN_CFG_PACK(13, 0, RZV2H_MPXED_PIN_FUNCS(A) | PIN_CFG_IEN),
	RZG2L_VARIABLE_PIN_CFG_PACK(13, 1, RZV2H_MPXED_PIN_FUNCS(A)),
	RZG2L_VARIABLE_PIN_CFG_PACK(13, 2, RZV2H_MPXED_PIN_FUNCS(A)),
	RZG2L_VARIABLE_PIN_CFG_PACK(13, 3, RZV2H_MPXED_PIN_FUNCS(A)),
	RZG2L_VARIABLE_PIN_CFG_PACK(13, 4, RZV2H_MPXED_PIN_FUNCS(A)),
	RZG2L_VARIABLE_PIN_CFG_PACK(13, 5, RZV2H_MPXED_PIN_FUNCS(A)),
	RZG2L_VARIABLE_PIN_CFG_PACK(13, 6, RZV2H_MPXED_PIN_FUNCS(A)),
	RZG2L_VARIABLE_PIN_CFG_PACK(13, 7, RZV2H_MPXED_PIN_FUNCS(A)),

	/* PG */
	RZG2L_VARIABLE_PIN_CFG_PACK(16, 0, RZV2H_MPXED_PIN_FUNCS(A)),
	RZG2L_VARIABLE_PIN_CFG_PACK(16, 1, RZV2H_MPXED_PIN_FUNCS(A) | PIN_CFG_IEN),
	RZG2L_VARIABLE_PIN_CFG_PACK(16, 2, RZV2H_MPXED_PIN_FUNCS(A) | PIN_CFG_IEN),
	RZG2L_VARIABLE_PIN_CFG_PACK(16, 3, RZV2H_MPXED_PIN_FUNCS(A) | PIN_CFG_IEN),
	RZG2L_VARIABLE_PIN_CFG_PACK(16, 4, RZV2H_MPXED_PIN_FUNCS(A) | PIN_CFG_IEN),
	RZG2L_VARIABLE_PIN_CFG_PACK(16, 5, RZV2H_MPXED_PIN_FUNCS(A) | PIN_CFG_IEN),
	RZG2L_VARIABLE_PIN_CFG_PACK(16, 6, RZV2H_MPXED_PIN_FUNCS(A)),
	RZG2L_VARIABLE_PIN_CFG_PACK(16, 7, RZV2H_MPXED_PIN_FUNCS(A)),

	/* PH */
	RZG2L_VARIABLE_PIN_CFG_PACK(17, 0, RZV2H_MPXED_PIN_FUNCS(A)),
	RZG2L_VARIABLE_PIN_CFG_PACK(17, 1, RZV2H_MPXED_PIN_FUNCS(A) | PIN_CFG_IEN),
	RZG2L_VARIABLE_PIN_CFG_PACK(17, 2, RZV2H_MPXED_PIN_FUNCS(A) | PIN_CFG_IEN),
	RZG2L_VARIABLE_PIN_CFG_PACK(17, 3, RZV2H_MPXED_PIN_FUNCS(A) | PIN_CFG_IEN),
	RZG2L_VARIABLE_PIN_CFG_PACK(17, 4, RZV2H_MPXED_PIN_FUNCS(A) | PIN_CFG_IEN),
	RZG2L_VARIABLE_PIN_CFG_PACK(17, 5, RZV2H_MPXED_PIN_FUNCS(A) | PIN_CFG_IEN),

	/* PJ */
	RZG2L_VARIABLE_PIN_CFG_PACK(19, 0, RZV2H_MPXED_PIN_FUNCS(A) | PIN_CFG_IEN),
	RZG2L_VARIABLE_PIN_CFG_PACK(19, 1, RZV2H_MPXED_PIN_FUNCS(A)),
	RZG2L_VARIABLE_PIN_CFG_PACK(19, 2, RZV2H_MPXED_PIN_FUNCS(A)),
	RZG2L_VARIABLE_PIN_CFG_PACK(19, 3, RZV2H_MPXED_PIN_FUNCS(A)),
	RZG2L_VARIABLE_PIN_CFG_PACK(19, 4, RZV2H_MPXED_PIN_FUNCS(A)),
};
...
static u16 rzg2l_iolh_val_to_ua(const struct rzg2l_hwcfg *hwcfg, u32 caps, u8 val)
{
	...
	if (caps & PIN_CFG_IOLH_D)
		return hwcfg->iolh_groupd_ua[val];
				...
				enum rzg2l_iolh_index ps_index, u16 ua)
{
	...
	if (caps & PIN_CFG_IOLH_D)
		array = &hwcfg->iolh_groupd_ua[ps_index];
				     ...
				     unsigned long *config)
{
	...
	case PIN_CONFIG_DRIVE_STRENGTH: {
		...
		if (hwcfg->has_v2h_iolh_cfg) {
			if (!(cfg & (PIN_CFG_IOLH_A | PIN_CFG_IOLH_B | PIN_CFG_IOLH_D)))
				return -EINVAL;

			index = rzg2l_read_pin_config(pctrl, IOLH(off), bit, IOLH_MASK);

			if ((cfg & PIN_CFG_IOLH_D))
				arg = hwcfg->iolh_groupd_ua[index + RZG2L_IOLH_IDX_1V8] / 1000;
			else
...
static const u64 r9a09g057_gpio_configs[] = {
	RZG2L_GPIO_PORT_PACK(8, 0x20, RZV2H_MPXED_PIN_FUNCS(A)), /* P0 */
	RZG2L_GPIO_PORT_PACK(6, 0x21, RZV2H_MPXED_PIN_FUNCS(B)), /* P1 */
	RZG2L_GPIO_PORT_PACK(2, 0x22, RZG2L_MPXED_COMMON_PIN_FUNCS(D) |
				      PIN_CFG_NOD),		 /* P2 */
	RZG2L_GPIO_PORT_PACK(8, 0x23, RZV2H_MPXED_PIN_FUNCS(A)), /* P3 */
	RZG2L_GPIO_PORT_PACK(8, 0x24, RZV2H_MPXED_PIN_FUNCS(A)), /* P4 */
	RZG2L_GPIO_PORT_PACK(8, 0x25, RZV2H_MPXED_PIN_FUNCS(A)), /* P5 */
	RZG2L_GPIO_PORT_PACK(8, 0x26, RZV2H_MPXED_PIN_FUNCS(A) |
				      PIN_CFG_ELC),		 /* P6 */
	RZG2L_GPIO_PORT_PACK(8, 0x27, RZV2H_MPXED_PIN_FUNCS(A)), /* P7 */
	RZG2L_GPIO_PORT_PACK(8, 0x28, RZV2H_MPXED_PIN_FUNCS(A) |
				      PIN_CFG_ELC),		 /* P8 */
	RZG2L_GPIO_PORT_PACK(8, 0x29, RZV2H_MPXED_PIN_FUNCS(A)), /* P9 */
	RZG2L_GPIO_PORT_PACK(8, 0x2a, RZV2H_MPXED_PIN_FUNCS(A)), /* PA */
...
static const u64 r9a09g047_gpio_configs[] = {
	RZG2L_GPIO_PORT_PACK(8, 0x20, RZV2H_MPXED_PIN_FUNCS(A)),	/* P0 */
	RZG2L_GPIO_PORT_PACK(8, 0x21, RZV2H_MPXED_PIN_FUNCS(A) |
				      PIN_CFG_ELC),			/* P1 */
	RZG2L_GPIO_PORT_PACK(2, 0x22, RZG2L_MPXED_COMMON_PIN_FUNCS(D) |
				      PIN_CFG_NOD |
				      PIN_CFG_SMT),			/* P2 */
	RZG2L_GPIO_PORT_PACK(8, 0x23, RZV2H_MPXED_PIN_FUNCS(A)),	/* P3 */
	RZG2L_GPIO_PORT_PACK(6, 0x24, RZV2H_MPXED_PIN_FUNCS(A)),	/* P4 */
	RZG2L_GPIO_PORT_PACK(7, 0x25, RZV2H_MPXED_PIN_FUNCS(A)),	/* P5 */
	RZG2L_GPIO_PORT_PACK(7, 0x26, RZV2H_MPXED_PIN_FUNCS(A)),	/* P6 */
	RZG2L_GPIO_PORT_PACK(8, 0x27, RZV2H_MPXED_PIN_FUNCS(A)),	/* P7 */
	RZG2L_GPIO_PORT_PACK(6, 0x28, RZV2H_MPXED_PIN_FUNCS(A) |
				      PIN_CFG_ELC),			/* P8 */
	RZG2L_GPIO_PORT_PACK(0, 0x29, RZV2H_MPXED_PIN_FUNCS(A)),	/* P9 */
	RZG2L_GPIO_PORT_PACK_VARIABLE(8, 0x2a),				/* PA */
	RZG2L_GPIO_PORT_PACK(8, 0x2b, RZV2H_MPXED_PIN_FUNCS(A)),	/* PB */
	RZG2L_GPIO_PORT_PACK(3, 0x2c, RZV2H_MPXED_PIN_FUNCS(A)),	/* PC */
	RZG2L_GPIO_PORT_PACK_VARIABLE(8, 0x2d),				/* PD */
	RZG2L_GPIO_PORT_PACK(8, 0x2e, RZV2H_MPXED_PIN_FUNCS(A)),	/* PE */
	RZG2L_GPIO_PORT_PACK(3, 0x2f, RZV2H_MPXED_PIN_FUNCS(A)),	/* PF */
	RZG2L_GPIO_PORT_PACK_VARIABLE(8, 0x30),				/* PG */
	RZG2L_GPIO_PORT_PACK_VARIABLE(6, 0x31),				/* PH */
	RZG2L_GPIO_PORT_PACK(0, 0x32, RZV2H_MPXED_PIN_FUNCS(A)),	/* PI */
	RZG2L_GPIO_PORT_PACK_VARIABLE(5, 0x33),				/* PJ */
	RZG2L_GPIO_PORT_PACK(4, 0x34, RZV2H_MPXED_PIN_FUNCS(A)),	/* PK */
	RZG2L_GPIO_PORT_PACK(8, 0x35, RZV2H_MPXED_PIN_FUNCS(A)),	/* PL */
	RZG2L_GPIO_PORT_PACK(8, 0x36, RZV2H_MPXED_PIN_FUNCS(A)),	/* PM */
	RZG2L_GPIO_PORT_PACK(0, 0x37, RZV2H_MPXED_PIN_FUNCS(A)),	/* PN */
	RZG2L_GPIO_PORT_PACK(0, 0x38, RZV2H_MPXED_PIN_FUNCS(A)),	/* PO */
	RZG2L_GPIO_PORT_PACK(0, 0x39, RZV2H_MPXED_PIN_FUNCS(A)),	/* PP */
	RZG2L_GPIO_PORT_PACK(0, 0x3a, RZV2H_MPXED_PIN_FUNCS(A)),	/* PQ */
	RZG2L_GPIO_PORT_PACK(0, 0x3b, RZV2H_MPXED_PIN_FUNCS(A)),	/* PR */
	RZG2L_GPIO_PORT_PACK(4, 0x3c, RZV2H_MPXED_PIN_FUNCS(A)),	/* PS */
};
...
static struct rzg2l_dedicated_configs rzv2h_dedicated_pins[] = {
	{ "NMI", RZG2L_SINGLE_PIN_PACK(0x1, 0, (PIN_CFG_FILONOFF | PIN_CFG_FILNUM |
						PIN_CFG_FILCLKSEL)) },
	{ "TMS_SWDIO", RZG2L_SINGLE_PIN_PACK(0x3, 0, (PIN_CFG_IOLH_A | PIN_CFG_SR |
						      PIN_CFG_IEN)) },
	{ "TDO", RZG2L_SINGLE_PIN_PACK(0x3, 2, (PIN_CFG_SR | PIN_CFG_IOLH_A)) },
	{ "WDTUDFCA", RZG2L_SINGLE_PIN_PACK(0x5, 0, (PIN_CFG_IOLH_A | PIN_CFG_SR |
						     PIN_CFG_PUPD | PIN_CFG_NOD)) },
	{ "WDTUDFCM", RZG2L_SINGLE_PIN_PACK(0x5, 1, (PIN_CFG_IOLH_A | PIN_CFG_SR |
						     PIN_CFG_PUPD | PIN_CFG_NOD)) },
	{ "SCIF_RXD", RZG2L_SINGLE_PIN_PACK(0x6, 0, (PIN_CFG_IOLH_A | PIN_CFG_SR |
						     PIN_CFG_PUPD)) },
	{ "SCIF_TXD", RZG2L_SINGLE_PIN_PACK(0x6, 1, (PIN_CFG_IOLH_A | PIN_CFG_SR |
						     PIN_CFG_PUPD)) },
	{ "XSPI0_CKP", RZG2L_SINGLE_PIN_PACK(0x7, 0, (PIN_CFG_IOLH_B | PIN_CFG_SR |
						      PIN_CFG_PUPD | PIN_CFG_OEN)) },
	{ "XSPI0_CKN", RZG2L_SINGLE_PIN_PACK(0x7, 1, (PIN_CFG_IOLH_B | PIN_CFG_SR |
						      PIN_CFG_PUPD | PIN_CFG_OEN)) },
	{ "XSPI0_CS0N", RZG2L_SINGLE_PIN_PACK(0x7, 2, (PIN_CFG_IOLH_A | PIN_CFG_SR |
						       PIN_CFG_PUPD | PIN_CFG_OEN)) },
	{ "XSPI0_DS", RZG2L_SINGLE_PIN_PACK(0x7, 3, (PIN_CFG_IOLH_B | PIN_CFG_SR |
						     PIN_CFG_PUPD)) },
	{ "XSPI0_RESET0N", RZG2L_SINGLE_PIN_PACK(0x7, 4, (PIN_CFG_IOLH_A | PIN_CFG_SR |
							  PIN_CFG_PUPD | PIN_CFG_OEN)) },
	...
	{ "XSPI0_IO0", RZG2L_SINGLE_PIN_PACK(0x8, 0, (PIN_CFG_IOLH_B | PIN_CFG_SR |
						      PIN_CFG_PUPD)) },
	{ "XSPI0_IO1", RZG2L_SINGLE_PIN_PACK(0x8, 1, (PIN_CFG_IOLH_B | PIN_CFG_SR |
						      PIN_CFG_PUPD)) },
	{ "XSPI0_IO2", RZG2L_SINGLE_PIN_PACK(0x8, 2, (PIN_CFG_IOLH_B | PIN_CFG_SR |
						      PIN_CFG_PUPD)) },
	{ "XSPI0_IO3", RZG2L_SINGLE_PIN_PACK(0x8, 3, (PIN_CFG_IOLH_B | PIN_CFG_SR |
						      PIN_CFG_PUPD)) },
	{ "XSPI0_IO4", RZG2L_SINGLE_PIN_PACK(0x8, 4, (PIN_CFG_IOLH_B | PIN_CFG_SR |
						      PIN_CFG_PUPD)) },
	{ "XSPI0_IO5", RZG2L_SINGLE_PIN_PACK(0x8, 5, (PIN_CFG_IOLH_B | PIN_CFG_SR |
						      PIN_CFG_PUPD)) },
	{ "XSPI0_IO6", RZG2L_SINGLE_PIN_PACK(0x8, 6, (PIN_CFG_IOLH_B | PIN_CFG_SR |
						      PIN_CFG_PUPD)) },
	{ "XSPI0_IO7", RZG2L_SINGLE_PIN_PACK(0x8, 7, (PIN_CFG_IOLH_B | PIN_CFG_SR |
						      PIN_CFG_PUPD)) },
	{ "SD0CLK", RZG2L_SINGLE_PIN_PACK(0x9, 0, (PIN_CFG_IOLH_B | PIN_CFG_SR)) },
	{ "SD0CMD", RZG2L_SINGLE_PIN_PACK(0x9, 1, (PIN_CFG_IOLH_B | PIN_CFG_SR |
						   PIN_CFG_IEN | PIN_CFG_PUPD)) },
	{ "SD0RSTN", RZG2L_SINGLE_PIN_PACK(0x9, 2, (PIN_CFG_IOLH_B | PIN_CFG_SR)) },
	{ "SD0DAT0", RZG2L_SINGLE_PIN_PACK(0xa, 0, (PIN_CFG_IOLH_B | PIN_CFG_SR |
						    PIN_CFG_IEN | PIN_CFG_PUPD)) },
	{ "SD0DAT1", RZG2L_SINGLE_PIN_PACK(0xa, 1, (PIN_CFG_IOLH_B | PIN_CFG_SR |
						    PIN_CFG_IEN | PIN_CFG_PUPD)) },
	{ "SD0DAT2", RZG2L_SINGLE_PIN_PACK(0xa, 2, (PIN_CFG_IOLH_B | PIN_CFG_SR |
						    PIN_CFG_IEN | PIN_CFG_PUPD)) },
	{ "SD0DAT3", RZG2L_SINGLE_PIN_PACK(0xa, 3, (PIN_CFG_IOLH_B | PIN_CFG_SR |
						    PIN_CFG_IEN | PIN_CFG_PUPD)) },
	{ "SD0DAT4", RZG2L_SINGLE_PIN_PACK(0xa, 4, (PIN_CFG_IOLH_B | PIN_CFG_SR |
						    PIN_CFG_IEN | PIN_CFG_PUPD)) },
	{ "SD0DAT5", RZG2L_SINGLE_PIN_PACK(0xa, 5, (PIN_CFG_IOLH_B | PIN_CFG_SR |
						    PIN_CFG_IEN | PIN_CFG_PUPD)) },
	{ "SD0DAT6", RZG2L_SINGLE_PIN_PACK(0xa, 6, (PIN_CFG_IOLH_B | PIN_CFG_SR |
						    PIN_CFG_IEN | PIN_CFG_PUPD)) },
	{ "SD0DAT7", RZG2L_SINGLE_PIN_PACK(0xa, 7, (PIN_CFG_IOLH_B | PIN_CFG_SR |
						    PIN_CFG_IEN | PIN_CFG_PUPD)) },
	{ "SD1CLK", RZG2L_SINGLE_PIN_PACK(0xb, 0, (PIN_CFG_IOLH_B | PIN_CFG_SR)) },
	{ "SD1CMD", RZG2L_SINGLE_PIN_PACK(0xb, 1, (PIN_CFG_IOLH_B | PIN_CFG_SR |
						   PIN_CFG_IEN | PIN_CFG_PUPD)) },
	{ "SD1DAT0", RZG2L_SINGLE_PIN_PACK(0xc, 0, (PIN_CFG_IOLH_B | PIN_CFG_SR |
						    PIN_CFG_IEN | PIN_CFG_PUPD)) },
	{ "SD1DAT1", RZG2L_SINGLE_PIN_PACK(0xc, 1, (PIN_CFG_IOLH_B | PIN_CFG_SR |
						    PIN_CFG_IEN | PIN_CFG_PUPD)) },
	{ "SD1DAT2", RZG2L_SINGLE_PIN_PACK(0xc, 2, (PIN_CFG_IOLH_B | PIN_CFG_SR |
						    PIN_CFG_IEN | PIN_CFG_PUPD)) },
	{ "SD1DAT3", RZG2L_SINGLE_PIN_PACK(0xc, 3, (PIN_CFG_IOLH_B | PIN_CFG_SR |
						    PIN_CFG_IEN | PIN_CFG_PUPD)) },
	{ "PCIE0_RSTOUTB", RZG2L_SINGLE_PIN_PACK(0xe, 0, (PIN_CFG_IOLH_A | PIN_CFG_SR)) },
	{ "PCIE1_RSTOUTB", RZG2L_SINGLE_PIN_PACK(0xe, 1, (PIN_CFG_IOLH_A | PIN_CFG_SR)) },
	{ "ET0_MDIO", RZG2L_SINGLE_PIN_PACK(0xf, 0, (PIN_CFG_IOLH_B | PIN_CFG_SR |
						     PIN_CFG_IEN | PIN_CFG_PUPD)) },
	{ "ET0_MDC", RZG2L_SINGLE_PIN_PACK(0xf, 1, (PIN_CFG_IOLH_B | PIN_CFG_SR |
						    PIN_CFG_PUPD)) },
	{ "ET0_RXCTL_RXDV", RZG2L_SINGLE_PIN_PACK(0x10, 0, (PIN_CFG_PUPD)) },
	{ "ET0_TXCTL_TXEN", RZG2L_SINGLE_PIN_PACK(0x10, 1, (PIN_CFG_IOLH_B | PIN_CFG_SR |
							    PIN_CFG_PUPD)) },
	{ "ET0_TXER", RZG2L_SINGLE_PIN_PACK(0x10, 2, (PIN_CFG_IOLH_B | PIN_CFG_SR |
						      PIN_CFG_PUPD)) },
	{ "ET0_RXER", RZG2L_SINGLE_PIN_PACK(0x10, 3, (PIN_CFG_PUPD)) },
	{ "ET0_RXC_RXCLK", RZG2L_SINGLE_PIN_PACK(0x10, 4, (PIN_CFG_PUPD)) },
	{ "ET0_TXC_TXCLK", RZG2L_SINGLE_PIN_PACK(0x10, 5, (PIN_CFG_IOLH_B | PIN_CFG_SR |
							   PIN_CFG_PUPD | PIN_CFG_OEN)) },
	{ "ET0_CRS", RZG2L_SINGLE_PIN_PACK(0x10, 6, (PIN_CFG_PUPD)) },
	{ "ET0_COL", RZG2L_SINGLE_PIN_PACK(0x10, 7, (PIN_CFG_PUPD)) },
	{ "ET0_TXD0", RZG2L_SINGLE_PIN_PACK(0x11, 0, (PIN_CFG_IOLH_B | PIN_CFG_SR |
						      PIN_CFG_PUPD)) },
	{ "ET0_TXD1", RZG2L_SINGLE_PIN_PACK(0x11, 1, (PIN_CFG_IOLH_B | PIN_CFG_SR |
						      PIN_CFG_PUPD)) },
	{ "ET0_TXD2", RZG2L_SINGLE_PIN_PACK(0x11, 2, (PIN_CFG_IOLH_B | PIN_CFG_SR |
						      PIN_CFG_PUPD)) },
	{ "ET0_TXD3", RZG2L_SINGLE_PIN_PACK(0x11, 3, (PIN_CFG_IOLH_B | PIN_CFG_SR |
						      PIN_CFG_PUPD)) },
	...
	{ "ET1_MDIO", RZG2L_SINGLE_PIN_PACK(0x12, 0, (PIN_CFG_IOLH_B | PIN_CFG_SR |
						      PIN_CFG_IEN | PIN_CFG_PUPD)) },
	{ "ET1_MDC", RZG2L_SINGLE_PIN_PACK(0x12, 1, (PIN_CFG_IOLH_B | PIN_CFG_SR |
						     PIN_CFG_PUPD)) },
	{ "ET1_RXCTL_RXDV", RZG2L_SINGLE_PIN_PACK(0x13, 0, (PIN_CFG_PUPD)) },
	{ "ET1_TXCTL_TXEN", RZG2L_SINGLE_PIN_PACK(0x13, 1, (PIN_CFG_IOLH_B | PIN_CFG_SR |
							    PIN_CFG_PUPD)) },
	{ "ET1_TXER", RZG2L_SINGLE_PIN_PACK(0x13, 2, (PIN_CFG_IOLH_B | PIN_CFG_SR |
						      PIN_CFG_PUPD)) },
	{ "ET1_RXER", RZG2L_SINGLE_PIN_PACK(0x13, 3, (PIN_CFG_PUPD)) },
	{ "ET1_RXC_RXCLK", RZG2L_SINGLE_PIN_PACK(0x13, 4, (PIN_CFG_PUPD)) },
	{ "ET1_TXC_TXCLK", RZG2L_SINGLE_PIN_PACK(0x13, 5, (PIN_CFG_IOLH_B | PIN_CFG_SR |
							   PIN_CFG_PUPD | PIN_CFG_OEN)) },
	{ "ET1_CRS", RZG2L_SINGLE_PIN_PACK(0x13, 6, (PIN_CFG_PUPD)) },
	{ "ET1_COL", RZG2L_SINGLE_PIN_PACK(0x13, 7, (PIN_CFG_PUPD)) },
	{ "ET1_TXD0", RZG2L_SINGLE_PIN_PACK(0x14, 0, (PIN_CFG_IOLH_B | PIN_CFG_SR |
						      PIN_CFG_PUPD)) },
	{ "ET1_TXD1", RZG2L_SINGLE_PIN_PACK(0x14, 1, (PIN_CFG_IOLH_B | PIN_CFG_SR |
						      PIN_CFG_PUPD)) },
	{ "ET1_TXD2", RZG2L_SINGLE_PIN_PACK(0x14, 2, (PIN_CFG_IOLH_B | PIN_CFG_SR |
						      PIN_CFG_PUPD)) },
	{ "ET1_TXD3", RZG2L_SINGLE_PIN_PACK(0x14, 3, (PIN_CFG_IOLH_B | PIN_CFG_SR |
						      PIN_CFG_PUPD)) },
...
static struct rzg2l_dedicated_configs rzg3e_dedicated_pins[] = {
	{ "WDTUDF_CA", RZG2L_SINGLE_PIN_PACK(0x5, 0, (PIN_CFG_SR | PIN_CFG_IOLH_A |
						      PIN_CFG_PUPD | PIN_CFG_NOD)) },
	{ "WDTUDF_CM", RZG2L_SINGLE_PIN_PACK(0x5, 1, (PIN_CFG_SR | PIN_CFG_IOLH_A |
						      PIN_CFG_PUPD | PIN_CFG_NOD)) },
	{ "SCIF_RXD", RZG2L_SINGLE_PIN_PACK(0x6, 0, (PIN_CFG_SR | PIN_CFG_IOLH_A |
						     PIN_CFG_PUPD)) },
	{ "SCIF_TXD", RZG2L_SINGLE_PIN_PACK(0x6, 1, (PIN_CFG_SR | PIN_CFG_IOLH_A |
						     PIN_CFG_PUPD)) },
	{ "SD0_CLK", RZG2L_SINGLE_PIN_PACK(0x9, 0, (PIN_CFG_SR | PIN_CFG_IOLH_A)) },
	{ "SD0_CMD", RZG2L_SINGLE_PIN_PACK(0x9, 1, (PIN_CFG_SR | PIN_CFG_IOLH_A |
						    PIN_CFG_IEN | PIN_CFG_PUPD)) },
	{ "SD0_RSTN", RZG2L_SINGLE_PIN_PACK(0x9, 2, (PIN_CFG_SR | PIN_CFG_IOLH_A)) },
	{ "QSD0_PWEN", RZG2L_SINGLE_PIN_PACK(0x9, 3, (PIN_CFG_SR | PIN_CFG_IOLH_A)) },
	{ "QSD0_IOVS", RZG2L_SINGLE_PIN_PACK(0x9, 4, (PIN_CFG_SR | PIN_CFG_IOLH_A)) },
	{ "QSD0_DAT0", RZG2L_SINGLE_PIN_PACK(0xa, 0, (PIN_CFG_SR | PIN_CFG_IOLH_A |
						      PIN_CFG_IEN | PIN_CFG_PUPD)) },
	{ "QSD0_DAT1", RZG2L_SINGLE_PIN_PACK(0xa, 1, (PIN_CFG_SR | PIN_CFG_IOLH_A |
						      PIN_CFG_IEN | PIN_CFG_PUPD)) },
	{ "QSD0_DAT2", RZG2L_SINGLE_PIN_PACK(0xa, 2, (PIN_CFG_SR | PIN_CFG_IOLH_A |
						      PIN_CFG_IEN | PIN_CFG_PUPD)) },
	{ "QSD0_DAT3", RZG2L_SINGLE_PIN_PACK(0xa, 3, (PIN_CFG_SR | PIN_CFG_IOLH_A |
						      PIN_CFG_IEN | PIN_CFG_PUPD)) },
	{ "QSD0_DAT4", RZG2L_SINGLE_PIN_PACK(0xa, 4, (PIN_CFG_SR | PIN_CFG_IOLH_A |
						      PIN_CFG_IEN | PIN_CFG_PUPD)) },
	{ "QSD0_DAT5", RZG2L_SINGLE_PIN_PACK(0xa, 5, (PIN_CFG_SR | PIN_CFG_IOLH_A |
						      PIN_CFG_IEN | PIN_CFG_PUPD)) },
	{ "QSD0_DAT6", RZG2L_SINGLE_PIN_PACK(0xa, 6, (PIN_CFG_SR | PIN_CFG_IOLH_A |
						      PIN_CFG_IEN | PIN_CFG_PUPD)) },
	{ "QSD0_DAT7", RZG2L_SINGLE_PIN_PACK(0xa, 7, (PIN_CFG_SR | PIN_CFG_IOLH_A |
						      PIN_CFG_IEN | PIN_CFG_PUPD)) },
};
...
static const struct rzg2l_hwcfg rzv2h_hwcfg = {
	...
	.iolh_groupa_ua = {
		/* 3v3 power source */
		[RZG2L_IOLH_IDX_3V3] = 1000, 4000, 2000, 6000,
	},
	.iolh_groupd_ua = {
		/* 3v3 power source */
		[RZG2L_IOLH_IDX_1V8] = 1000, 2000, 3000, 4000,
	},
	.has_v2h_iolh_cfg = true,
	.tint_start_index = 17,
};
