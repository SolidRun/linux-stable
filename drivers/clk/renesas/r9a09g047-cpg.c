...
static const struct rzv2h_mod_clk r9a09g047_mod_clks[] = {
	...
	DEF_MOD("poega",			CLK_PLLCLN_DIV32, 3, 3, 1, 19),
	DEF_MOD("poegb",			CLK_PLLCLN_DIV32, 3, 4, 1, 20),
	DEF_MOD("poegc",			CLK_PLLCLN_DIV32, 3, 5, 1, 21),
	DEF_MOD("poegd",			CLK_PLLCLN_DIV32, 3, 6, 1, 22),
	DEF_MOD("poege",			CLK_PLLCLN_DIV32, 3, 7, 1, 23),
	DEF_MOD("poegf",			CLK_PLLCLN_DIV32, 3, 8, 1, 24),
	DEF_MOD("poegg",			CLK_PLLCLN_DIV32, 3, 9, 1, 25),
	DEF_MOD("poegh",			CLK_PLLCLN_DIV32, 3, 10, 1, 26),
