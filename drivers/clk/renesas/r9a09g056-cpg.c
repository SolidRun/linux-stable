...
static const struct rzv2h_mod_clk r9a09g056_mod_clks[] __initconst = {
	DEF_MOD_CRITICAL("dmac0_aclk",		CLK_PLLCM33_GEAR, 0, 0, 0, 0,
						BUS_MSTOP(5, BIT(9))),
	DEF_MOD_CRITICAL("dmac1_aclk",		CLK_PLLDTY_ACPU_DIV2, 0, 1, 0, 1,
						BUS_MSTOP(3, BIT(2))),
	DEF_MOD_CRITICAL("dmac2_aclk",		CLK_PLLDTY_ACPU_DIV2, 0, 2, 0, 2,
						BUS_MSTOP(3, BIT(3))),
	DEF_MOD_CRITICAL("dmac3_aclk",		CLK_PLLDTY_RCPU_DIV4, 0, 3, 0, 3,
						BUS_MSTOP(10, BIT(11))),
	DEF_MOD_CRITICAL("dmac4_aclk",		CLK_PLLDTY_RCPU_DIV4, 0, 4, 0, 4,
						BUS_MSTOP(10, BIT(12))),
	DEF_MOD_CRITICAL("icu",			CLK_PLLCM33_DIV16, 0, 5, 0, 5, 0),
	...
	DEF_MOD("adg_0_clk_195m",		CLK_PLLCLN_DIV8, 15, 10, 7, 26,
						BUS_MSTOP(2, BIT(2))),
	DEF_MOD("adg_0_audio_clka",		AUDIO_CLKA, 15, 11, 7, 27, 0),
	DEF_MOD("adg_0_audio_clkb",		AUDIO_CLKB, 15, 12, 7, 28, 0),
	DEF_MOD("adg_0_audio_clkc",		AUDIO_CLKC, 15, 13, 7, 29, 0),
	...
	DEF_MOD("drpai_0_mclk",			CLK_PLLETH, 17, 6, 8, 22,
						BUS_MSTOP(8, BIT(9))),
	DEF_MOD("adg_ssi_0_clk",		CLK_PLLCLN_DIV8, 22, 0, -1, -1, 0),
	DEF_MOD("adg_ssi_1_clk",		CLK_PLLCLN_DIV8, 22, 1, -1, -1, 0),
	DEF_MOD("adg_ssi_2_clk",		CLK_PLLCLN_DIV8, 22, 2, -1, -1, 0),
	DEF_MOD("adg_ssi_3_clk",		CLK_PLLCLN_DIV8, 22, 3, -1, -1, 0),
	DEF_MOD("adg_ssi_4_clk",		CLK_PLLCLN_DIV8, 22, 4, -1, -1, 0),
	DEF_MOD("adg_ssi_5_clk",		CLK_PLLCLN_DIV8, 22, 5, -1, -1, 0),
	DEF_MOD("adg_ssi_6_clk",		CLK_PLLCLN_DIV8, 22, 6, -1, -1, 0),
	DEF_MOD("adg_ssi_7_clk",		CLK_PLLCLN_DIV8, 22, 7, -1, -1, 0),
	DEF_MOD("adg_ssi_8_clk",		CLK_PLLCLN_DIV8, 22, 8, -1, -1, 0),
	DEF_MOD("adg_ssi_9_clk",		CLK_PLLCLN_DIV8, 22, 9, -1, -1, 0),
	DEF_MOD("adg_spdif_0_clk",		CLK_PLLCLN_DIV8, 22, 10, -1, -1, 0),
	DEF_MOD("adg_spdif_1_clk",		CLK_PLLCLN_DIV8, 22, 11, -1, -1, 0),
	DEF_MOD("adg_spdif_2_clk",		CLK_PLLCLN_DIV8, 22, 12, -1, -1, 0),
	DEF_MOD("dvc_0_clk",			CLK_PLLCLN_DIV8, 23, 0, -1, -1, 0),
	DEF_MOD("dvc_1_clk",			CLK_PLLCLN_DIV8, 23, 1, -1, -1, 0),
	DEF_MOD("ctu_0_mix0_clk",		CLK_PLLCLN_DIV8, 23, 2, -1, -1, 0),
	DEF_MOD("ctu_1_mix1_clk",		CLK_PLLCLN_DIV8, 23, 3, -1, -1, 0),
	DEF_MOD("src_0_clk",			CLK_PLLCLN_DIV8, 23, 4, -1, -1, 0),
	DEF_MOD("src_1_clk",			CLK_PLLCLN_DIV8, 23, 5, -1, -1, 0),
	DEF_MOD("src_2_clk",			CLK_PLLCLN_DIV8, 23, 6, -1, -1, 0),
	DEF_MOD("src_3_clk",			CLK_PLLCLN_DIV8, 23, 7, -1, -1, 0),
	DEF_MOD("src_4_clk",			CLK_PLLCLN_DIV8, 23, 8, -1, -1, 0),
	DEF_MOD("src_5_clk",			CLK_PLLCLN_DIV8, 23, 9, -1, -1, 0),
	DEF_MOD("src_6_clk",			CLK_PLLCLN_DIV8, 23, 10, -1, -1, 0),
	DEF_MOD("src_7_clk",			CLK_PLLCLN_DIV8, 23, 11, -1, -1, 0),
	DEF_MOD("src_8_clk",			CLK_PLLCLN_DIV8, 23, 12, -1, -1, 0),
	DEF_MOD("src_9_clk",			CLK_PLLCLN_DIV8, 23, 13, -1, -1, 0),
	DEF_MOD("scu_supply_clk",		CLK_PLLCLN_DIV8, 23, 14, -1, -1, 0),
	DEF_MOD("ssif_supply_clk",		CLK_PLLCLN_DIV8, 24, 0, -1, -1, 0),
	DEF_MOD("ssi_0_clk",			CLK_PLLCLN_DIV8, 24, 1, -1, -1, 0),
	DEF_MOD("ssi_1_clk",			CLK_PLLCLN_DIV8, 24, 2, -1, -1, 0),
	DEF_MOD("ssi_2_clk",			CLK_PLLCLN_DIV8, 24, 3, -1, -1, 0),
	DEF_MOD("ssi_3_clk",			CLK_PLLCLN_DIV8, 24, 4, -1, -1, 0),
	DEF_MOD("ssi_4_clk",			CLK_PLLCLN_DIV8, 24, 5, -1, -1, 0),
	DEF_MOD("ssi_5_clk",			CLK_PLLCLN_DIV8, 24, 6, -1, -1, 0),
	DEF_MOD("ssi_6_clk",			CLK_PLLCLN_DIV8, 24, 7, -1, -1, 0),
	DEF_MOD("ssi_7_clk",			CLK_PLLCLN_DIV8, 24, 8, -1, -1, 0),
	DEF_MOD("ssi_8_clk",			CLK_PLLCLN_DIV8, 24, 9, -1, -1, 0),
	DEF_MOD("ssi_9_clk",			CLK_PLLCLN_DIV8, 24, 10, -1, -1, 0),
};
