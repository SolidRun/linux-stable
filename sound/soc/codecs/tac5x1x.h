...
/* TAC5X1X_CLK2 */
#define TAC5X1X_CLK2_SRC_SEL_MASK	GENMASK(3, 1)
#define TAC5X1X_CLK2_SRC_PASI_BCLK	(0 << 1) /* Primary ASI BCLK */
#define TAC5X1X_CLK2_SRC_PASI_CCLK	(1 << 1) /* Primary ASI CCLK */
#define TAC5X1X_CLK2_SRC_SASI_BCLK	(2 << 1) /* Secondy ASI BCLK */
#define TAC5X1X_CLK2_SRC_SASI_CCLK	(3 << 1) /* Secondary ASI CCLK */
#define TAC5X1X_CLK2_SRC_FIXED_RATE	(4 << 1) /* Fixed CCLK */
#define TAC5X1X_CLK2_SRC_INTERNAL	(5 << 1) /* Internal Oscillator */
...
#define	TAC5X1X_GPIO_CCLK_IN	14
...
#define	TAC5X1X_GPI_DISABLE	0
#define	TAC5X1X_GPI_GPI		1
#define	TAC5X1X_GPI_CCLK_IN	2

/* TAC5X1X_INTF0 */
#define TAC5X1X_INTF0_CCLK_SEL_MASK	GENMASK(6, 5)
#define TAC5X1X_INTF0_CCLK_SEL_NONE	0
#define TAC5X1X_INTF0_CCLK_SEL_GPIO1	(1 << 5)
#define TAC5X1X_INTF0_CCLK_SEL_GPIO2	(2 << 5)
#define TAC5X1X_INTF0_CCLK_SEL_GPI1	(3 << 5)
